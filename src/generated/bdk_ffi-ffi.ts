...
interface NativeModuleInterface {
    ...
    ubrn_uniffi_bdk_ffi_fn_method_wallet_broadcast_with_esplora(ptr: bigint, url: Uint8Array, psbt: bigint, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ...
    ubrn_uniffi_bdk_ffi_fn_method_wallet_drain(ptr: bigint, address: Uint8Array, feeRate: number, esploraUrl: Uint8Array, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ...
    ubrn_uniffi_bdk_ffi_fn_method_wallet_full_scan_with_esplora(ptr: bigint, url: Uint8Array, stopGap: bigint, uniffi_out_err: UniffiRustCallStatus): void;
    ...
    ubrn_uniffi_bdk_ffi_fn_method_wallet_send(ptr: bigint, address: Uint8Array, amountSats: bigint, feeRate: number, esploraUrl: Uint8Array, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ...
    ubrn_uniffi_bdk_ffi_fn_method_wallet_sync_with_esplora(ptr: bigint, url: Uint8Array, stopGap: bigint, uniffi_out_err: UniffiRustCallStatus): void;
...
const getter: () => NativeModuleInterface = () => (globalThis as any).NativeBdkFfi;
