...
var _NativeBdkSdk = _interopRequireDefault(require("./NativeBdkSdk.js"));
var bdk_ffi = _interopRequireWildcard(require("./generated/bdk_ffi.js"));
Object.keys(bdk_ffi).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === bdk_ffi[key]) return;
...
if (!rustInstalled) {
  _NativeBdkSdk.default.installRustCrate();
  rustInstalled = true;
}
