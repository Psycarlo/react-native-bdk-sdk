...
async function createWalletFromMultipath(descriptor, network, dbPath, asyncOpts_) /*throws*/{
  ...
  try {
    return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
      return (0, _bdk_ffiFfi.default)().ubrn_uniffi_bdk_ffi_fn_func_create_wallet_from_multipath(FfiConverterString.lower(descriptor), FfiConverterTypeNetwork.lower(network), FfiConverterString.lower(dbPath));
    }, /*pollFunc:*/(0, _bdk_ffiFfi.default)().ubrn_ffi_bdk_ffi_rust_future_poll_u64, /*cancelFunc:*/(0, _bdk_ffiFfi.default)().ubrn_ffi_bdk_ffi_rust_future_cancel_u64, /*completeFunc:*/(0, _bdk_ffiFfi.default)().ubrn_ffi_bdk_ffi_rust_future_complete_u64, /*freeFunc:*/(0, _bdk_ffiFfi.default)().ubrn_ffi_bdk_ffi_rust_future_free_u64, /*liftFunc:*/FfiConverterTypeWallet.lift.bind(FfiConverterTypeWallet), /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError));
  } catch (__error) {
    if (uniffiIsDebug && __error instanceof Error) {
      __error.stack = __stack;
...
class Wallet extends _uniffiBindgenReactNative.UniffiAbstractObject {
  ...
  static newFromMultipath(descriptor, network, dbPath) /*throws*/{
    return FfiConverterTypeWallet.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return (0, _bdk_ffiFfi.default)().ubrn_uniffi_bdk_ffi_fn_constructor_wallet_new_from_multipath(FfiConverterString.lower(descriptor), FfiConverterTypeNetwork.lower(network), FfiConverterString.lower(dbPath), callStatus);
    }, /*liftString:*/FfiConverterString.lift));
  }
...
function uniffiEnsureInitialized() {
  ...
  if ((0, _bdk_ffiFfi.default)().ubrn_uniffi_bdk_ffi_checksum_func_create_wallet_from_multipath() !== 55216) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_func_create_wallet_from_multipath");
  }
  ...
  if ((0, _bdk_ffiFfi.default)().ubrn_uniffi_bdk_ffi_checksum_constructor_wallet_new_from_multipath() !== 35912) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_constructor_wallet_new_from_multipath");
  }
