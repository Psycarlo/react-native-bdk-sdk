...
class Wallet extends _uniffiBindgenReactNative.UniffiAbstractObject {
  ...
  broadcastWithEsplora(url, psbt) /*throws*/{
    return FfiConverterString.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return (0, _bdk_ffiFfi.default)().ubrn_uniffi_bdk_ffi_fn_method_wallet_broadcast_with_esplora(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(url), FfiConverterTypePsbt.lower(psbt), callStatus);
    }, /*liftString:*/FfiConverterString.lift));
  }
  ...
  drain(address, feeRate, esploraUrl) /*throws*/{
    return FfiConverterString.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return (0, _bdk_ffiFfi.default)().ubrn_uniffi_bdk_ffi_fn_method_wallet_drain(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(address), _uniffiBindgenReactNative.FfiConverterFloat64.lower(feeRate), FfiConverterString.lower(esploraUrl), callStatus);
    }, /*liftString:*/FfiConverterString.lift));
  }
  ...
  fullScanWithEsplora(url, stopGap) /*throws*/{
    uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      (0, _bdk_ffiFfi.default)().ubrn_uniffi_bdk_ffi_fn_method_wallet_full_scan_with_esplora(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(url), _uniffiBindgenReactNative.FfiConverterUInt64.lower(stopGap), callStatus);
    }, /*liftString:*/FfiConverterString.lift);
  }
  ...
  syncWithEsplora(url, stopGap) /*throws*/{
    uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      (0, _bdk_ffiFfi.default)().ubrn_uniffi_bdk_ffi_fn_method_wallet_sync_with_esplora(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(url), _uniffiBindgenReactNative.FfiConverterUInt64.lower(stopGap), callStatus);
    }, /*liftString:*/FfiConverterString.lift);
  }
...
function uniffiEnsureInitialized() {
  ...
  if ((0, _bdk_ffiFfi.default)().ubrn_uniffi_bdk_ffi_checksum_method_wallet_broadcast_with_esplora() !== 13170) {
  ...
  if ((0, _bdk_ffiFfi.default)().ubrn_uniffi_bdk_ffi_checksum_method_wallet_drain() !== 18307) {
  ...
  if ((0, _bdk_ffiFfi.default)().ubrn_uniffi_bdk_ffi_checksum_method_wallet_full_scan_with_esplora() !== 546) {
  ...
  if ((0, _bdk_ffiFfi.default)().ubrn_uniffi_bdk_ffi_checksum_method_wallet_send() !== 38826) {
  ...
  if ((0, _bdk_ffiFfi.default)().ubrn_uniffi_bdk_ffi_checksum_method_wallet_sync_with_esplora() !== 32845) {
