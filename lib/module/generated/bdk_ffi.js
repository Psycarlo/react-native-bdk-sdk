...
import { AbstractFfiConverterByteArray, FfiConverterArray, FfiConverterArrayBuffer, FfiConverterBool, FfiConverterFloat64, FfiConverterInt32, FfiConverterInt64, FfiConverterObject, FfiConverterObjectWithCallbacks, FfiConverterOptional, FfiConverterUInt32, FfiConverterUInt64, FfiConverterUInt8, UniffiAbstractObject, UniffiEnum, UniffiError, UniffiInternalError, UniffiResult, UniffiRustCaller, destructorGuardSymbol, pointerLiteralSymbol, uniffiCreateFfiConverterString, uniffiCreateRecord, uniffiRustCallAsync, uniffiTraitInterfaceCall, uniffiTypeNameSymbol } from "@ubjs/core";
...
export function addressFromScript(scriptHex, network) /*throws*/{
  const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_bdk_ffi_fn_func_address_from_script(FfiConverterString.lower(scriptHex, nativeModule().rustbuffer_alloc), FfiConverterTypeNetwork.lower(network, nativeModule().rustbuffer_alloc), callStatus);
...
export function createDescriptor(mnemonic, template, keychain, network) /*throws*/{
  const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_bdk_ffi_fn_func_create_descriptor(FfiConverterTypeMnemonic.lower(mnemonic, nativeModule().rustbuffer_alloc), FfiConverterTypeDescriptorTemplate.lower(template, nativeModule().rustbuffer_alloc), FfiConverterTypeKeychainKind.lower(keychain, nativeModule().rustbuffer_alloc), FfiConverterTypeNetwork.lower(network, nativeModule().rustbuffer_alloc), callStatus);
  }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  try {
    return FfiConverterString.lift(__rb);
  } finally {
...
export function createDescriptorFromString(mnemonic, template, keychain, network) /*throws*/{
  const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_bdk_ffi_fn_func_create_descriptor_from_string(FfiConverterString.lower(mnemonic, nativeModule().rustbuffer_alloc), FfiConverterTypeDescriptorTemplate.lower(template, nativeModule().rustbuffer_alloc), FfiConverterTypeKeychainKind.lower(keychain, nativeModule().rustbuffer_alloc), FfiConverterTypeNetwork.lower(network, nativeModule().rustbuffer_alloc), callStatus);
  }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  try {
    return FfiConverterString.lift(__rb);
  } finally {
...
export function createPublicDescriptor(xpub, template, keychain, network) /*throws*/{
  const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_bdk_ffi_fn_func_create_public_descriptor(FfiConverterString.lower(xpub, nativeModule().rustbuffer_alloc), FfiConverterTypeDescriptorTemplate.lower(template, nativeModule().rustbuffer_alloc), FfiConverterTypeKeychainKind.lower(keychain, nativeModule().rustbuffer_alloc), FfiConverterTypeNetwork.lower(network, nativeModule().rustbuffer_alloc), callStatus);
  }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  try {
    return FfiConverterString.lift(__rb);
  } finally {
...
export function createSingleKeyDescriptor(key, template, network) /*throws*/{
  const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_bdk_ffi_fn_func_create_single_key_descriptor(FfiConverterString.lower(key, nativeModule().rustbuffer_alloc), FfiConverterTypeSingleKeyDescriptorTemplate.lower(template, nativeModule().rustbuffer_alloc), FfiConverterTypeNetwork.lower(network, nativeModule().rustbuffer_alloc), callStatus);
  }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  try {
    return FfiConverterString.lift(__rb);
  } finally {
...
export async function createWallet(descriptor, changeDescriptor, network, dbPath, asyncOpts_) /*throws*/{
  ...
  try {
    return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_func_create_wallet(FfiConverterString.lower(descriptor, nativeModule().rustbuffer_alloc), FfiConverterOptionalString.lower(changeDescriptor, nativeModule().rustbuffer_alloc), FfiConverterTypeNetwork.lower(network, nativeModule().rustbuffer_alloc), FfiConverterString.lower(dbPath, nativeModule().rustbuffer_alloc));
    }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_u64, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_u64, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_u64, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_u64,
...
export async function createWalletFromMultipath(descriptor, network, dbPath, asyncOpts_) /*throws*/{
  const __stack = uniffiIsDebug ? new Error().stack : undefined;
  try {
    return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_func_create_wallet_from_multipath(FfiConverterString.lower(descriptor, nativeModule().rustbuffer_alloc), FfiConverterTypeNetwork.lower(network, nativeModule().rustbuffer_alloc), FfiConverterString.lower(dbPath, nativeModule().rustbuffer_alloc));
    }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_u64, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_u64, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_u64, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_u64,
    // Async returns always go through the JS-side converter: the
    // FFI symbol returns the future handle (u64), and the user-level
    // RustBuffer comes back via the shared `rust_future_complete_*`
...
export function exportWallet(wallet, label, includeBlockHeight) /*throws*/{
  const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_bdk_ffi_fn_func_export_wallet(FfiConverterTypeWallet.lower(wallet, nativeModule().rustbuffer_alloc), FfiConverterString.lower(label, nativeModule().rustbuffer_alloc), FfiConverterBool.lower(includeBlockHeight, nativeModule().rustbuffer_alloc), callStatus);
  }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  try {
    return FfiConverterString.lift(__rb);
  } finally {
...
export function isValidAddress(address, network) {
  return FfiConverterBool.lift(uniffiCaller.rustCall(/*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_bdk_ffi_fn_func_is_valid_address(FfiConverterString.lower(address, nativeModule().rustbuffer_alloc), FfiConverterTypeNetwork.lower(network, nativeModule().rustbuffer_alloc), callStatus);
  }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString)));
}
...
export function validateDescriptor(descriptor, network) {
  return FfiConverterBool.lift(uniffiCaller.rustCall(/*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_bdk_ffi_fn_func_validate_descriptor(FfiConverterString.lower(descriptor, nativeModule().rustbuffer_alloc), FfiConverterTypeNetwork.lower(network, nativeModule().rustbuffer_alloc), callStatus);
  }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString)));
}
...
export function walletNameFromDescriptor(descriptor, changeDescriptor, network) /*throws*/{
  const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_bdk_ffi_fn_func_wallet_name_from_descriptor(FfiConverterString.lower(descriptor, nativeModule().rustbuffer_alloc), FfiConverterOptionalString.lower(changeDescriptor, nativeModule().rustbuffer_alloc), FfiConverterTypeNetwork.lower(network, nativeModule().rustbuffer_alloc), callStatus);
  }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  try {
    return FfiConverterString.lift(__rb);
  } finally {
...
const FfiConverterTypeTxInput = (() => {
  class FFIConverter extends AbstractFfiConverterByteArray {
    ...
    allocationSize(value) {
      return FfiConverterString.allocationSize(value.previousTxid) + FfiConverterUInt32.allocationSize(value.previousVout) + FfiConverterUInt32.allocationSize(value.sequence) + FfiConverterString.allocationSize(value.scriptSigHex) + FfiConverterSequenceString.allocationSize(value.witness);
    }
  }
  return new FFIConverter();
})();
...
const FfiConverterTypeTxDetails = (() => {
  class FFIConverter extends AbstractFfiConverterByteArray {
    ...
    allocationSize(value) {
      return FfiConverterString.allocationSize(value.txid) + FfiConverterUInt64.allocationSize(value.sent) + FfiConverterUInt64.allocationSize(value.received) + FfiConverterOptionalUInt64.allocationSize(value.fee) + FfiConverterOptionalFloat64.allocationSize(value.feeRate) + FfiConverterInt64.allocationSize(value.balanceDelta) + FfiConverterOptionalTypeConfirmationBlockTime.allocationSize(value.confirmationBlockTime) + FfiConverterInt32.allocationSize(value.version) + FfiConverterUInt32.allocationSize(value.locktime) + FfiConverterSequenceTypeTxInput.allocationSize(value.inputs) + FfiConverterSequenceTypeTxOutput.allocationSize(value.outputs);
    }
  }
  return new FFIConverter();
})();
...
export let KyotoRecoveryStart_Tags = /*#__PURE__*/function (KyotoRecoveryStart_Tags) {
...
export const KyotoRecoveryStart = (() => {
   ...
   */
  class Genesis_ extends UniffiEnum {
    /**
     * @private
     * This field is private and should not be used, use `tag` instead.
     */
    [uniffiTypeNameSymbol] = "KyotoRecoveryStart";
   ...
   */
  class SegwitActivation_ extends UniffiEnum {
    /**
     * @private
     * This field is private and should not be used, use `tag` instead.
     */
   ...
   */
  class TaprootActivation_ extends UniffiEnum {
    /**
     * @private
     * This field is private and should not be used, use `tag` instead.
     */
   ...
   */
  class FromBlock_ extends UniffiEnum {
    /**
     * @private
     * This field is private and should not be used, use `tag` instead.
     */
...
// Enum: KyotoScanType
export let KyotoScanType_Tags = /*#__PURE__*/function (KyotoScanType_Tags) {
...
export const KyotoScanType = (() => {
   ...
   */
  class Sync_ extends UniffiEnum {
    /**
     * @private
     * This field is private and should not be used, use `tag` instead.
     */
    [uniffiTypeNameSymbol] = "KyotoScanType";
   ...
   */
  class Recovery_ extends UniffiEnum {
    /**
     * @private
     * This field is private and should not be used, use `tag` instead.
     */
...
export class ElectrumClient extends UniffiAbstractObject {
  ...
  constructor(url) /*throws*/{
    ...
    const pointer = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_constructor_electrumclient_new(FfiConverterString.lower(url, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
...
const uniffiTypeElectrumClientObjectFactory = (() => {
  return {
    ...
    isConcreteType(obj_) {
      return obj_[destructorGuardSymbol] && obj_[uniffiTypeNameSymbol] === "ElectrumClient";
    }
  };
})();
 ...
 * Create once, pass to multiple wallet methods to avoid re-handshaking each call.
 */
export class EsploraClient extends UniffiAbstractObject {
  [uniffiTypeNameSymbol] = "EsploraClient";
  /**
  ...
  constructor(url) /*throws*/{
    super();
    const pointer = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_constructor_esploraclient_new(FfiConverterString.lower(url, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    this[pointerLiteralSymbol] = pointer;
    this[destructorGuardSymbol] = uniffiTypeEsploraClientObjectFactory.bless(pointer);
  }
  uniffiDestroy() {
    const ptr = this[destructorGuardSymbol];
    if (ptr !== undefined) {
...
const uniffiTypeEsploraClientObjectFactory = (() => {
  return {
    ...
    bless(p) {
      return uniffiCaller.rustCall(/*caller:*/status => nativeModule().ubrn_uniffi_internal_fn_method_esploraclient_ffi__bless_pointer(p, status), /*liftString:*/FfiConverterString.lift);
    },
    unbless(ptr_) {
      ptr_.markDestroyed();
    },
    ...
    clonePointer(obj_) {
      const pointer = this.pointer(obj_);
      return uniffiCaller.rustCall(/*caller:*/callStatus => nativeModule().ubrn_uniffi_bdk_ffi_fn_clone_esploraclient(pointer, callStatus), /*liftString:*/FfiConverterString.lift);
    },
    freePointer(pointer) {
      uniffiCaller.rustCall(/*caller:*/callStatus => nativeModule().ubrn_uniffi_bdk_ffi_fn_free_esploraclient(pointer, callStatus), /*liftString:*/FfiConverterString.lift);
    },
    isConcreteType(obj_) {
      return obj_[destructorGuardSymbol] && obj_[uniffiTypeNameSymbol] === "EsploraClient";
    }
  };
})();
const FfiConverterTypeEsploraClient = new FfiConverterObject(uniffiTypeEsploraClientObjectFactory);
 ...
 * called from a background thread and must not block.
 */
export class FullScanProgressInspectorImpl extends UniffiAbstractObject {
  [uniffiTypeNameSymbol] = "FullScanProgressInspectorImpl";
  // No primary constructor declared for this class.
  constructor(pointer) {
    super();
    this[pointerLiteralSymbol] = pointer;
    this[destructorGuardSymbol] = uniffiTypeFullScanProgressInspectorImplObjectFactory.bless(pointer);
  }
  ...
  inspect(keychain, index, visited) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_fullscanprogressinspector_inspect(uniffiTypeFullScanProgressInspectorImplObjectFactory.clonePointer(this), FfiConverterTypeKeychainKind.lower(keychain, nativeModule().rustbuffer_alloc), FfiConverterUInt32.lower(index, nativeModule().rustbuffer_alloc), FfiConverterUInt64.lower(visited, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  uniffiDestroy() {
    const ptr = this[destructorGuardSymbol];
...
const uniffiTypeFullScanProgressInspectorImplObjectFactory = (() => {
  return {
    ...
    bless(p) {
      return uniffiCaller.rustCall(/*caller:*/status => nativeModule().ubrn_uniffi_internal_fn_method_fullscanprogressinspector_ffi__bless_pointer(p, status), /*liftString:*/FfiConverterString.lift);
    },
    unbless(ptr_) {
      ptr_.markDestroyed();
    },
    ...
    clonePointer(obj_) {
      const pointer = this.pointer(obj_);
      return uniffiCaller.rustCall(/*caller:*/callStatus => nativeModule().ubrn_uniffi_bdk_ffi_fn_clone_fullscanprogressinspector(pointer, callStatus), /*liftString:*/FfiConverterString.lift);
    },
    freePointer(pointer) {
      uniffiCaller.rustCall(/*caller:*/callStatus => nativeModule().ubrn_uniffi_bdk_ffi_fn_free_fullscanprogressinspector(pointer, callStatus), /*liftString:*/FfiConverterString.lift);
    },
    isConcreteType(obj_) {
      return obj_[destructorGuardSymbol] && obj_[uniffiTypeNameSymbol] === "FullScanProgressInspectorImpl";
    }
  };
})();
const FfiConverterTypeFullScanProgressInspector = new FfiConverterObjectWithCallbacks(uniffiTypeFullScanProgressInspectorImplObjectFactory);
...
const uniffiCallbackInterfaceFullScanProgressInspector = {
  ...
  vtable: {
    inspect: (uniffiHandle, keychain, index, visited) => {
      const uniffiMakeCall = () => {
        ...
        return jsCallback.inspect(FfiConverterTypeKeychainKind.lift(keychain), FfiConverterUInt32.lift(index), FfiConverterUInt64.lift(visited));
      };
  ...
  register: () => {
    nativeModule().ubrn_uniffi_bdk_ffi_fn_init_callback_vtable_fullscanprogressinspector(uniffiCallbackInterfaceFullScanProgressInspector.vtable);
  }
};
 ...
 * and call [`KyotoClient::shutdown`] (or simply drop it) when finished.
 */
export class KyotoClient extends UniffiAbstractObject {
  [uniffiTypeNameSymbol] = "KyotoClient";
  /**
  ...
  constructor(wallet, scanType, requiredPeers, peers, dataDir, handler) /*throws*/{
    super();
    const pointer = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_constructor_kyotoclient_new(FfiConverterTypeWallet.lower(wallet, nativeModule().rustbuffer_alloc), FfiConverterTypeKyotoScanType.lower(scanType, nativeModule().rustbuffer_alloc), FfiConverterUInt8.lower(requiredPeers, nativeModule().rustbuffer_alloc), FfiConverterSequenceString.lower(peers, nativeModule().rustbuffer_alloc), FfiConverterString.lower(dataDir, nativeModule().rustbuffer_alloc), FfiConverterTypeKyotoNodeEventHandler.lower(handler, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    this[pointerLiteralSymbol] = pointer;
    this[destructorGuardSymbol] = uniffiTypeKyotoClientObjectFactory.bless(pointer);
  }
  ...
  isRunning() {
    return FfiConverterBool.lift(uniffiCaller.rustCall(/*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_kyotoclient_is_running(uniffiTypeKyotoClientObjectFactory.clonePointer(this), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString)));
  }
  ...
  shutdown() /*throws*/{
    uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_kyotoclient_shutdown(uniffiTypeKyotoClientObjectFactory.clonePointer(this), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  uniffiDestroy() {
    const ptr = this[destructorGuardSymbol];
...
const uniffiTypeKyotoClientObjectFactory = (() => {
  return {
    ...
    bless(p) {
      return uniffiCaller.rustCall(/*caller:*/status => nativeModule().ubrn_uniffi_internal_fn_method_kyotoclient_ffi__bless_pointer(p, status), /*liftString:*/FfiConverterString.lift);
    },
    unbless(ptr_) {
      ptr_.markDestroyed();
    },
    ...
    clonePointer(obj_) {
      const pointer = this.pointer(obj_);
      return uniffiCaller.rustCall(/*caller:*/callStatus => nativeModule().ubrn_uniffi_bdk_ffi_fn_clone_kyotoclient(pointer, callStatus), /*liftString:*/FfiConverterString.lift);
    },
    freePointer(pointer) {
      uniffiCaller.rustCall(/*caller:*/callStatus => nativeModule().ubrn_uniffi_bdk_ffi_fn_free_kyotoclient(pointer, callStatus), /*liftString:*/FfiConverterString.lift);
    },
    isConcreteType(obj_) {
      return obj_[destructorGuardSymbol] && obj_[uniffiTypeNameSymbol] === "KyotoClient";
    }
  };
})();
const FfiConverterTypeKyotoClient = new FfiConverterObject(uniffiTypeKyotoClientObjectFactory);
 ...
 * should return quickly (e.g. forward to a UI log) — they must not block.
 */
export class KyotoNodeEventHandlerImpl extends UniffiAbstractObject {
  [uniffiTypeNameSymbol] = "KyotoNodeEventHandlerImpl";
  // No primary constructor declared for this class.
  constructor(pointer) {
    super();
    this[pointerLiteralSymbol] = pointer;
    this[destructorGuardSymbol] = uniffiTypeKyotoNodeEventHandlerImplObjectFactory.bless(pointer);
  }
  ...
  onInfo(message) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_kyotonodeeventhandler_on_info(uniffiTypeKyotoNodeEventHandlerImplObjectFactory.clonePointer(this), FfiConverterString.lower(message, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  ...
  onWarning(message) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_kyotonodeeventhandler_on_warning(uniffiTypeKyotoNodeEventHandlerImplObjectFactory.clonePointer(this), FfiConverterString.lower(message, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  uniffiDestroy() {
    const ptr = this[destructorGuardSymbol];
...
const uniffiTypeKyotoNodeEventHandlerImplObjectFactory = (() => {
  return {
    ...
    bless(p) {
      return uniffiCaller.rustCall(/*caller:*/status => nativeModule().ubrn_uniffi_internal_fn_method_kyotonodeeventhandler_ffi__bless_pointer(p, status), /*liftString:*/FfiConverterString.lift);
    },
    unbless(ptr_) {
      ptr_.markDestroyed();
    },
    ...
    clonePointer(obj_) {
      const pointer = this.pointer(obj_);
      return uniffiCaller.rustCall(/*caller:*/callStatus => nativeModule().ubrn_uniffi_bdk_ffi_fn_clone_kyotonodeeventhandler(pointer, callStatus), /*liftString:*/FfiConverterString.lift);
    },
    freePointer(pointer) {
      uniffiCaller.rustCall(/*caller:*/callStatus => nativeModule().ubrn_uniffi_bdk_ffi_fn_free_kyotonodeeventhandler(pointer, callStatus), /*liftString:*/FfiConverterString.lift);
    },
    isConcreteType(obj_) {
      return obj_[destructorGuardSymbol] && obj_[uniffiTypeNameSymbol] === "KyotoNodeEventHandlerImpl";
    }
  };
})();
const FfiConverterTypeKyotoNodeEventHandler = new FfiConverterObjectWithCallbacks(uniffiTypeKyotoNodeEventHandlerImplObjectFactory);
...
const uniffiCallbackInterfaceKyotoNodeEventHandler = {
  ...
  register: () => {
    nativeModule().ubrn_uniffi_bdk_ffi_fn_init_callback_vtable_kyotonodeeventhandler(uniffiCallbackInterfaceKyotoNodeEventHandler.vtable);
  }
};
...
export class Mnemonic extends UniffiAbstractObject {
  ...
  constructor(wordCount) /*throws*/{
    super();
    const pointer = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_constructor_mnemonic_new(FfiConverterTypeWordCount.lower(wordCount, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    this[pointerLiteralSymbol] = pointer;
  ...
  static fromEntropy(entropy) /*throws*/{
    return FfiConverterTypeMnemonic.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_constructor_mnemonic_from_entropy(FfiConverterArrayBuffer.lower(entropy, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString)));
  }
  ...
  static fromEntropyIn(entropy, language) /*throws*/{
    return FfiConverterTypeMnemonic.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_constructor_mnemonic_from_entropy_in(FfiConverterArrayBuffer.lower(entropy, nativeModule().rustbuffer_alloc), FfiConverterTypeLanguage.lower(language, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString)));
  }
  ...
  static fromString(mnemonic) /*throws*/{
    return FfiConverterTypeMnemonic.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_constructor_mnemonic_from_string(FfiConverterString.lower(mnemonic, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString)));
  }
  ...
  static fromStringIn(mnemonic, language) /*throws*/{
    return FfiConverterTypeMnemonic.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_constructor_mnemonic_from_string_in(FfiConverterString.lower(mnemonic, nativeModule().rustbuffer_alloc), FfiConverterTypeLanguage.lower(language, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString)));
  }
  ...
  toSeedHex(passphrase) {
    const __rb = uniffiCaller.rustCall(/*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_mnemonic_to_seed_hex(uniffiTypeMnemonicObjectFactory.clonePointer(this), FfiConverterString.lower(passphrase, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    try {
      return FfiConverterString.lift(__rb);
    } finally {
...
const uniffiTypeMnemonicObjectFactory = (() => {
  return {
    ...
    isConcreteType(obj_) {
      return obj_[destructorGuardSymbol] && obj_[uniffiTypeNameSymbol] === "Mnemonic";
    }
  };
})();
...
export class Psbt extends UniffiAbstractObject {
  ...
  constructor(psbtBase64) /*throws*/{
    super();
    const pointer = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_constructor_psbt_new(FfiConverterString.lower(psbtBase64, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    this[pointerLiteralSymbol] = pointer;
  ...
  getUtxoFor(inputIndex) {
    const __rb = uniffiCaller.rustCall(/*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_psbt_get_utxo_for(uniffiTypePsbtObjectFactory.clonePointer(this), FfiConverterUInt64.lower(inputIndex, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    try {
...
const uniffiTypePsbtObjectFactory = (() => {
  return {
    ...
    isConcreteType(obj_) {
      return obj_[destructorGuardSymbol] && obj_[uniffiTypeNameSymbol] === "Psbt";
    }
  };
})();
 ...
 * [`Wallet::broadcast_with_rpc`].
 */
export class RpcClient extends UniffiAbstractObject {
  [uniffiTypeNameSymbol] = "RpcClient";
  /**
  ...
  constructor(url, username, password, cookieFile) /*throws*/{
    super();
    const pointer = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_constructor_rpcclient_new(FfiConverterString.lower(url, nativeModule().rustbuffer_alloc), FfiConverterOptionalString.lower(username, nativeModule().rustbuffer_alloc), FfiConverterOptionalString.lower(password, nativeModule().rustbuffer_alloc), FfiConverterOptionalString.lower(cookieFile, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    this[pointerLiteralSymbol] = pointer;
    this[destructorGuardSymbol] = uniffiTypeRpcClientObjectFactory.bless(pointer);
  }
  ...
  getBlockHeight() /*throws*/{
    return FfiConverterUInt32.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_rpcclient_get_block_height(uniffiTypeRpcClientObjectFactory.clonePointer(this), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString)));
  }
  uniffiDestroy() {
    const ptr = this[destructorGuardSymbol];
...
const uniffiTypeRpcClientObjectFactory = (() => {
  return {
    ...
    bless(p) {
      return uniffiCaller.rustCall(/*caller:*/status => nativeModule().ubrn_uniffi_internal_fn_method_rpcclient_ffi__bless_pointer(p, status), /*liftString:*/FfiConverterString.lift);
    },
    unbless(ptr_) {
      ptr_.markDestroyed();
    },
    ...
    clonePointer(obj_) {
      const pointer = this.pointer(obj_);
      return uniffiCaller.rustCall(/*caller:*/callStatus => nativeModule().ubrn_uniffi_bdk_ffi_fn_clone_rpcclient(pointer, callStatus), /*liftString:*/FfiConverterString.lift);
    },
    freePointer(pointer) {
      uniffiCaller.rustCall(/*caller:*/callStatus => nativeModule().ubrn_uniffi_bdk_ffi_fn_free_rpcclient(pointer, callStatus), /*liftString:*/FfiConverterString.lift);
    },
    isConcreteType(obj_) {
      return obj_[destructorGuardSymbol] && obj_[uniffiTypeNameSymbol] === "RpcClient";
    }
  };
})();
const FfiConverterTypeRpcClient = new FfiConverterObject(uniffiTypeRpcClientObjectFactory);
 ...
 * thread and must return quickly — it must not block.
 */
export class RpcSyncProgressInspectorImpl extends UniffiAbstractObject {
  [uniffiTypeNameSymbol] = "RpcSyncProgressInspectorImpl";
  // No primary constructor declared for this class.
  constructor(pointer) {
    super();
    this[pointerLiteralSymbol] = pointer;
    this[destructorGuardSymbol] = uniffiTypeRpcSyncProgressInspectorImplObjectFactory.bless(pointer);
  }
  ...
  inspect(currentHeight, tipHeight) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_rpcsyncprogressinspector_inspect(uniffiTypeRpcSyncProgressInspectorImplObjectFactory.clonePointer(this), FfiConverterUInt32.lower(currentHeight, nativeModule().rustbuffer_alloc), FfiConverterUInt32.lower(tipHeight, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  uniffiDestroy() {
    const ptr = this[destructorGuardSymbol];
...
const uniffiTypeRpcSyncProgressInspectorImplObjectFactory = (() => {
  return {
    ...
    bless(p) {
      return uniffiCaller.rustCall(/*caller:*/status => nativeModule().ubrn_uniffi_internal_fn_method_rpcsyncprogressinspector_ffi__bless_pointer(p, status), /*liftString:*/FfiConverterString.lift);
    },
    unbless(ptr_) {
      ptr_.markDestroyed();
    },
    ...
    clonePointer(obj_) {
      const pointer = this.pointer(obj_);
      return uniffiCaller.rustCall(/*caller:*/callStatus => nativeModule().ubrn_uniffi_bdk_ffi_fn_clone_rpcsyncprogressinspector(pointer, callStatus), /*liftString:*/FfiConverterString.lift);
    },
    freePointer(pointer) {
      uniffiCaller.rustCall(/*caller:*/callStatus => nativeModule().ubrn_uniffi_bdk_ffi_fn_free_rpcsyncprogressinspector(pointer, callStatus), /*liftString:*/FfiConverterString.lift);
    },
    isConcreteType(obj_) {
      return obj_[destructorGuardSymbol] && obj_[uniffiTypeNameSymbol] === "RpcSyncProgressInspectorImpl";
    }
  };
})();
const FfiConverterTypeRpcSyncProgressInspector = new FfiConverterObjectWithCallbacks(uniffiTypeRpcSyncProgressInspectorImplObjectFactory);
...
const uniffiCallbackInterfaceRpcSyncProgressInspector = {
  ...
  vtable: {
    inspect: (uniffiHandle, currentHeight, tipHeight) => {
      const uniffiMakeCall = () => {
        ...
        return jsCallback.inspect(FfiConverterUInt32.lift(currentHeight), FfiConverterUInt32.lift(tipHeight));
      };
      const uniffiResult = UniffiResult.ready();
      const uniffiHandleSuccess = obj => {};
      const uniffiHandleError = (code, errBuf) => {
  ...
  register: () => {
    nativeModule().ubrn_uniffi_bdk_ffi_fn_init_callback_vtable_rpcsyncprogressinspector(uniffiCallbackInterfaceRpcSyncProgressInspector.vtable);
  }
};
 ...
 * return quickly — it must not block.
 */
export class SyncProgressInspectorImpl extends UniffiAbstractObject {
  [uniffiTypeNameSymbol] = "SyncProgressInspectorImpl";
  // No primary constructor declared for this class.
  constructor(pointer) {
    super();
    this[pointerLiteralSymbol] = pointer;
    this[destructorGuardSymbol] = uniffiTypeSyncProgressInspectorImplObjectFactory.bless(pointer);
  }
  ...
  inspect(consumed, total) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_syncprogressinspector_inspect(uniffiTypeSyncProgressInspectorImplObjectFactory.clonePointer(this), FfiConverterUInt64.lower(consumed, nativeModule().rustbuffer_alloc), FfiConverterUInt64.lower(total, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  uniffiDestroy() {
    const ptr = this[destructorGuardSymbol];
...
const uniffiTypeSyncProgressInspectorImplObjectFactory = (() => {
  return {
    ...
    bless(p) {
      return uniffiCaller.rustCall(/*caller:*/status => nativeModule().ubrn_uniffi_internal_fn_method_syncprogressinspector_ffi__bless_pointer(p, status), /*liftString:*/FfiConverterString.lift);
    },
    unbless(ptr_) {
      ptr_.markDestroyed();
    },
    ...
    clonePointer(obj_) {
      const pointer = this.pointer(obj_);
      return uniffiCaller.rustCall(/*caller:*/callStatus => nativeModule().ubrn_uniffi_bdk_ffi_fn_clone_syncprogressinspector(pointer, callStatus), /*liftString:*/FfiConverterString.lift);
    },
    freePointer(pointer) {
      uniffiCaller.rustCall(/*caller:*/callStatus => nativeModule().ubrn_uniffi_bdk_ffi_fn_free_syncprogressinspector(pointer, callStatus), /*liftString:*/FfiConverterString.lift);
    },
    isConcreteType(obj_) {
      return obj_[destructorGuardSymbol] && obj_[uniffiTypeNameSymbol] === "SyncProgressInspectorImpl";
    }
  };
})();
const FfiConverterTypeSyncProgressInspector = new FfiConverterObjectWithCallbacks(uniffiTypeSyncProgressInspectorImplObjectFactory);
...
const uniffiCallbackInterfaceSyncProgressInspector = {
  ...
  vtable: {
    inspect: (uniffiHandle, consumed, total) => {
      const uniffiMakeCall = () => {
        ...
        return jsCallback.inspect(FfiConverterUInt64.lift(consumed), FfiConverterUInt64.lift(total));
      };
      const uniffiResult = UniffiResult.ready();
      const uniffiHandleSuccess = obj => {};
      const uniffiHandleError = (code, errBuf) => {
  ...
  register: () => {
    nativeModule().ubrn_uniffi_bdk_ffi_fn_init_callback_vtable_syncprogressinspector(uniffiCallbackInterfaceSyncProgressInspector.vtable);
  }
};
...
export class Wallet extends UniffiAbstractObject {
  ...
  static newFromMultipath(descriptor, network, dbPath) /*throws*/{
    return FfiConverterTypeWallet.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_constructor_wallet_new_from_multipath(FfiConverterString.lower(descriptor, nativeModule().rustbuffer_alloc), FfiConverterTypeNetwork.lower(network, nativeModule().rustbuffer_alloc), FfiConverterString.lower(dbPath, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString)));
  }
  async broadcastWithElectrum(client, psbt, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_broadcast_with_electrum(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeElectrumClient.lower(client, nativeModule().rustbuffer_alloc), FfiConverterTypePsbt.lower(psbt, nativeModule().rustbuffer_alloc));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_rust_buffer, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_rust_buffer, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_rust_buffer, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_rust_buffer,
      // Async returns always go through the JS-side converter: the
      // FFI symbol returns the future handle (u64), and the user-level
      // RustBuffer comes back via the shared `rust_future_complete_*`
      // export. The bytes the runtime hands back must be deserialized
  ...
  async broadcastWithEsplora(client, psbt, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_broadcast_with_esplora(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeEsploraClient.lower(client, nativeModule().rustbuffer_alloc), FfiConverterTypePsbt.lower(psbt, nativeModule().rustbuffer_alloc));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_rust_buffer, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_rust_buffer, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_rust_buffer, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_rust_buffer,
      // Async returns always go through the JS-side converter: the
      // FFI symbol returns the future handle (u64), and the user-level
      // RustBuffer comes back via the shared `rust_future_complete_*`
  ...
  async broadcastWithKyoto(client, psbt, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_broadcast_with_kyoto(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeKyotoClient.lower(client, nativeModule().rustbuffer_alloc), FfiConverterTypePsbt.lower(psbt, nativeModule().rustbuffer_alloc));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_rust_buffer, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_rust_buffer, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_rust_buffer, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_rust_buffer,
      // Async returns always go through the JS-side converter: the
      // FFI symbol returns the future handle (u64), and the user-level
      // RustBuffer comes back via the shared `rust_future_complete_*`
  ...
  async broadcastWithRpc(client, psbt, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_broadcast_with_rpc(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeRpcClient.lower(client, nativeModule().rustbuffer_alloc), FfiConverterTypePsbt.lower(psbt, nativeModule().rustbuffer_alloc));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_rust_buffer, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_rust_buffer, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_rust_buffer, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_rust_buffer,
      // Async returns always go through the JS-side converter: the
      // FFI symbol returns the future handle (u64), and the user-level
      // RustBuffer comes back via the shared `rust_future_complete_*`
  ...
  buildFeeBump(txid, newFeeRate) /*throws*/{
    return FfiConverterTypePsbt.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_build_fee_bump(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(txid, nativeModule().rustbuffer_alloc), FfiConverterFloat64.lower(newFeeRate, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString)));
  }
  calculateFee(txHex) /*throws*/{
    return FfiConverterUInt64.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_calculate_fee(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(txHex, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString)));
  }
  calculateFeeRate(txHex) /*throws*/{
    return FfiConverterFloat64.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_calculate_fee_rate(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(txHex, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString)));
  }
  checkpoints() {
    const __rb = uniffiCaller.rustCall(/*caller:*/callStatus => {
  ...
  derivationIndex(keychain) {
    const __rb = uniffiCaller.rustCall(/*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_derivation_index(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeKeychainKind.lower(keychain, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    try {
  ...
  derivationOfSpk(scriptHex) /*throws*/{
    const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_derivation_of_spk(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(scriptHex, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    try {
  ...
  descriptorChecksum(keychain) /*throws*/{
    const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_descriptor_checksum(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeKeychainKind.lower(keychain, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    try {
      return FfiConverterString.lift(__rb);
    } finally {
  ...
  async drain(address, feeRate, client, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_drain(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(address, nativeModule().rustbuffer_alloc), FfiConverterFloat64.lower(feeRate, nativeModule().rustbuffer_alloc), FfiConverterTypeEsploraClient.lower(client, nativeModule().rustbuffer_alloc));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_rust_buffer, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_rust_buffer, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_rust_buffer, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_rust_buffer,
      // Async returns always go through the JS-side converter: the
      // FFI symbol returns the future handle (u64), and the user-level
      // RustBuffer comes back via the shared `rust_future_complete_*`
  ...
  async drainWithElectrum(address, feeRate, client, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_drain_with_electrum(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(address, nativeModule().rustbuffer_alloc), FfiConverterFloat64.lower(feeRate, nativeModule().rustbuffer_alloc), FfiConverterTypeElectrumClient.lower(client, nativeModule().rustbuffer_alloc));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_rust_buffer, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_rust_buffer, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_rust_buffer, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_rust_buffer,
      // Async returns always go through the JS-side converter: the
      // FFI symbol returns the future handle (u64), and the user-level
      // RustBuffer comes back via the shared `rust_future_complete_*`
  ...
  finalizePsbt(psbt) /*throws*/{
    return FfiConverterBool.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_finalize_psbt(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypePsbt.lower(psbt, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString)));
  }
  async fullScanWithElectrum(client, stopGap, inspector, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_full_scan_with_electrum(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeElectrumClient.lower(client, nativeModule().rustbuffer_alloc), FfiConverterUInt64.lower(stopGap, nativeModule().rustbuffer_alloc), FfiConverterOptionalTypeFullScanProgressInspector.lower(inspector, nativeModule().rustbuffer_alloc));
  ...
  async fullScanWithEsplora(client, stopGap, inspector, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_full_scan_with_esplora(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeEsploraClient.lower(client, nativeModule().rustbuffer_alloc), FfiConverterUInt64.lower(stopGap, nativeModule().rustbuffer_alloc), FfiConverterOptionalTypeFullScanProgressInspector.lower(inspector, nativeModule().rustbuffer_alloc));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_void, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_void, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_void, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString), /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
  ...
  getTx(txid) /*throws*/{
    const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_get_tx(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(txid, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    try {
  ...
  getUtxo(outpoint) /*throws*/{
    const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_get_utxo(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeOutPoint.lower(outpoint, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    try {
  ...
  insertTxout(outpoint, txout) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_insert_txout(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeOutPoint.lower(outpoint, nativeModule().rustbuffer_alloc), FfiConverterTypeTxOut.lower(txout, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  isMine(scriptHex) /*throws*/{
    return FfiConverterBool.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_is_mine(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(scriptHex, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString)));
  }
  keychains() {
    const __rb = uniffiCaller.rustCall(/*caller:*/callStatus => {
  ...
  listUnusedAddresses(keychain) /*throws*/{
    const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_list_unused_addresses(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeKeychainKind.lower(keychain, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    try {
  ...
  markUsed(keychain, index) {
    return FfiConverterBool.lift(uniffiCaller.rustCall(/*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_mark_used(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeKeychainKind.lower(keychain, nativeModule().rustbuffer_alloc), FfiConverterUInt32.lower(index, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString)));
  }
  network() {
    const __rb = uniffiCaller.rustCall(/*caller:*/callStatus => {
  ...
  nextDerivationIndex(keychain) {
    return FfiConverterUInt32.lift(uniffiCaller.rustCall(/*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_next_derivation_index(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeKeychainKind.lower(keychain, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString)));
  }
  nextUnusedAddress(keychain) /*throws*/{
    const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_next_unused_address(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeKeychainKind.lower(keychain, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    try {
  ...
  peekAddress(keychain, index) /*throws*/{
    const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_peek_address(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeKeychainKind.lower(keychain, nativeModule().rustbuffer_alloc), FfiConverterUInt32.lower(index, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    try {
      return FfiConverterTypeAddressInfo.lift(__rb);
    } finally {
  ...
  policies(keychain) /*throws*/{
    const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_policies(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeKeychainKind.lower(keychain, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    try {
      return FfiConverterOptionalString.lift(__rb);
    } finally {
  ...
  publicDescriptor(keychain) /*throws*/{
    const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_public_descriptor(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeKeychainKind.lower(keychain, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    try {
      return FfiConverterString.lift(__rb);
    } finally {
  ...
  revealAddressesTo(keychain, index) /*throws*/{
    const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_reveal_addresses_to(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeKeychainKind.lower(keychain, nativeModule().rustbuffer_alloc), FfiConverterUInt32.lower(index, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    try {
      return FfiConverterSequenceTypeAddressInfo.lift(__rb);
    } finally {
  ...
  revealNextAddress(keychain) /*throws*/{
    const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_reveal_next_address(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeKeychainKind.lower(keychain, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    try {
      return FfiConverterTypeAddressInfo.lift(__rb);
    } finally {
  ...
  async send(address, amountSats, feeRate, client, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_send(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(address, nativeModule().rustbuffer_alloc), FfiConverterUInt64.lower(amountSats, nativeModule().rustbuffer_alloc), FfiConverterFloat64.lower(feeRate, nativeModule().rustbuffer_alloc), FfiConverterTypeEsploraClient.lower(client, nativeModule().rustbuffer_alloc));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_rust_buffer, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_rust_buffer, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_rust_buffer, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_rust_buffer,
      // Async returns always go through the JS-side converter: the
      // FFI symbol returns the future handle (u64), and the user-level
      // RustBuffer comes back via the shared `rust_future_complete_*`
  ...
  async sendWithElectrum(address, amountSats, feeRate, client, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_send_with_electrum(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(address, nativeModule().rustbuffer_alloc), FfiConverterUInt64.lower(amountSats, nativeModule().rustbuffer_alloc), FfiConverterFloat64.lower(feeRate, nativeModule().rustbuffer_alloc), FfiConverterTypeElectrumClient.lower(client, nativeModule().rustbuffer_alloc));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_rust_buffer, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_rust_buffer, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_rust_buffer, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_rust_buffer,
      // Async returns always go through the JS-side converter: the
      // FFI symbol returns the future handle (u64), and the user-level
      // RustBuffer comes back via the shared `rust_future_complete_*`
  ...
  sentAndReceived(txHex) /*throws*/{
    const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_sent_and_received(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(txHex, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    try {
  ...
  sign(psbt) /*throws*/{
    return FfiConverterBool.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_sign(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypePsbt.lower(psbt, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString)));
  }
  async syncWithElectrum(client, stopGap, inspector, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_sync_with_electrum(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeElectrumClient.lower(client, nativeModule().rustbuffer_alloc), FfiConverterUInt64.lower(stopGap, nativeModule().rustbuffer_alloc), FfiConverterOptionalTypeSyncProgressInspector.lower(inspector, nativeModule().rustbuffer_alloc));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_void, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_void, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_void, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString), /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
  ...
  async syncWithEsplora(client, stopGap, inspector, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_sync_with_esplora(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeEsploraClient.lower(client, nativeModule().rustbuffer_alloc), FfiConverterUInt64.lower(stopGap, nativeModule().rustbuffer_alloc), FfiConverterOptionalTypeSyncProgressInspector.lower(inspector, nativeModule().rustbuffer_alloc));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_void, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_void, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_void, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString), /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
  ...
  async syncWithKyoto(client, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_sync_with_kyoto(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeKyotoClient.lower(client, nativeModule().rustbuffer_alloc));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_void, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_void, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_void, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString), /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
  ...
  async syncWithRpc(client, startHeight, fetchMempool, inspector, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_sync_with_rpc(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeRpcClient.lower(client, nativeModule().rustbuffer_alloc), FfiConverterUInt32.lower(startHeight, nativeModule().rustbuffer_alloc), FfiConverterBool.lower(fetchMempool, nativeModule().rustbuffer_alloc), FfiConverterOptionalTypeRpcSyncProgressInspector.lower(inspector, nativeModule().rustbuffer_alloc));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_void, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_void, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_void, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString), /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
  ...
  txDetails(txid) /*throws*/{
    const __rb = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_tx_details(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(txid, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
    try {
  ...
  unmarkUsed(keychain, index) {
    return FfiConverterBool.lift(uniffiCaller.rustCall(/*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_unmark_used(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeKeychainKind.lower(keychain, nativeModule().rustbuffer_alloc), FfiConverterUInt32.lower(index, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString)));
  }
  uniffiDestroy() {
    const ptr = this[destructorGuardSymbol];
...
const uniffiTypeWalletObjectFactory = (() => {
  return {
    ...
    isConcreteType(obj_) {
      return obj_[destructorGuardSymbol] && obj_[uniffiTypeNameSymbol] === "Wallet";
    }
  };
})();
...
export class TxBuilder extends UniffiAbstractObject {
  ...
  addData(data) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_add_data(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterArrayBuffer.lower(data, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  addGlobalXpubs() {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
  ...
  addRecipient(address, amountSats) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_add_recipient(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterString.lower(address, nativeModule().rustbuffer_alloc), FfiConverterUInt64.lower(amountSats, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  addUnspendable(outpoint) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_add_unspendable(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterTypeOutPoint.lower(outpoint, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  addUtxo(outpoint) /*throws*/{
    uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_add_utxo(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterTypeOutPoint.lower(outpoint, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  addUtxos(outpoints) /*throws*/{
    uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_add_utxos(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterSequenceTypeOutPoint.lower(outpoints, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  allowDust(allow) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_allow_dust(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterBool.lower(allow, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  changePolicy(policy) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_change_policy(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterTypeChangeSpendPolicy.lower(policy, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  currentHeight(height) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_current_height(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterUInt32.lower(height, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  doNotSpendChange() {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
  ...
  drainTo(address) /*throws*/{
    uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_drain_to(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterString.lower(address, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  drainWallet() {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
  ...
  enableRbfWithSequence(nsequence) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_enable_rbf_with_sequence(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterUInt32.lower(nsequence, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  excludeBelowConfirmations(minConfirms) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_exclude_below_confirmations(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterUInt32.lower(minConfirms, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  excludeUnconfirmed() {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
  ...
  feeAbsolute(feeSats) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_fee_absolute(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterUInt64.lower(feeSats, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  feeRate(satPerVbyte) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_fee_rate(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterFloat64.lower(satPerVbyte, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  ...
  async finish(wallet, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_finish(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterTypeWallet.lower(wallet, nativeModule().rustbuffer_alloc));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_u64, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_u64, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_u64, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_u64,
      // Async returns always go through the JS-side converter: the
      // FFI symbol returns the future handle (u64), and the user-level
      // RustBuffer comes back via the shared `rust_future_complete_*`
  ...
  nlocktime(lockHeight) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_nlocktime(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterUInt32.lower(lockHeight, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  onlySpendChange() {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
  ...
  ordering(ordering) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_ordering(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterTypeTxOrdering.lower(ordering, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  policyPath(pathMapJson, keychain) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_policy_path(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterString.lower(pathMapJson, nativeModule().rustbuffer_alloc), FfiConverterTypeKeychainKind.lower(keychain, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  setExactSequence(nsequence) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_set_exact_sequence(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterUInt32.lower(nsequence, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  setRecipients(recipients) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_set_recipients(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterSequenceTypeRecipient.lower(recipients, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  sighash(sighashType) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_sighash(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterUInt32.lower(sighashType, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  txVersion(version) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_tx_version(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterInt32.lower(version, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  unspendable(outpoints) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_txbuilder_unspendable(uniffiTypeTxBuilderObjectFactory.clonePointer(this), FfiConverterSequenceTypeOutPoint.lower(outpoints, nativeModule().rustbuffer_alloc), callStatus);
    }, /*liftString:*/FfiConverterString.lift.bind(FfiConverterString));
  }
  uniffiDestroy() {
    const ptr = this[destructorGuardSymbol];
...
const uniffiTypeTxBuilderObjectFactory = (() => {
  return {
    ...
    isConcreteType(obj_) {
      return obj_[destructorGuardSymbol] && obj_[uniffiTypeNameSymbol] === "TxBuilder";
    }
  };
})();
...
const FfiConverterSequenceTypeOutPoint = new FfiConverterArray(FfiConverterTypeOutPoint);

// FfiConverter for Array<BlockId>
const FfiConverterSequenceTypeBlockId = new FfiConverterArray(FfiConverterTypeBlockId);
...
const FfiConverterOptionalTypeFullScanProgressInspector = new FfiConverterOptional(FfiConverterTypeFullScanProgressInspector);
...
const FfiConverterSequenceTypeKeychainInfo = new FfiConverterArray(FfiConverterTypeKeychainInfo);
...
const FfiConverterSequenceTypeLocalOutput = new FfiConverterArray(FfiConverterTypeLocalOutput);

// FfiConverter for Array<AddressInfo>
const FfiConverterSequenceTypeAddressInfo = new FfiConverterArray(FfiConverterTypeAddressInfo);

// FfiConverter for SyncProgressInspector | undefined
const FfiConverterOptionalTypeSyncProgressInspector = new FfiConverterOptional(FfiConverterTypeSyncProgressInspector);

// FfiConverter for RpcSyncProgressInspector | undefined
const FfiConverterOptionalTypeRpcSyncProgressInspector = new FfiConverterOptional(FfiConverterTypeRpcSyncProgressInspector);

// FfiConverter for Array<TxDetails>
const FfiConverterSequenceTypeTxDetails = new FfiConverterArray(FfiConverterTypeTxDetails);
...
const FfiConverterSequenceTypeRecipient = new FfiConverterArray(FfiConverterTypeRecipient);
...
function uniffiEnsureInitialized() {
  ...
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_func_create_wallet_from_multipath() !== 55216) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_func_create_wallet_from_multipath");
  }
  ...
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_constructor_esploraclient_new() !== 22120) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_constructor_esploraclient_new");
  }
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_fullscanprogressinspector_inspect() !== 49334) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_method_fullscanprogressinspector_inspect");
  }
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_constructor_kyotoclient_new() !== 35516) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_constructor_kyotoclient_new");
  }
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_kyotoclient_is_running() !== 33975) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_method_kyotoclient_is_running");
  }
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_kyotoclient_shutdown() !== 18283) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_method_kyotoclient_shutdown");
  }
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_kyotonodeeventhandler_on_info() !== 29289) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_method_kyotonodeeventhandler_on_info");
  }
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_kyotonodeeventhandler_on_warning() !== 46310) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_method_kyotonodeeventhandler_on_warning");
  }
  ...
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_constructor_rpcclient_new() !== 40131) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_constructor_rpcclient_new");
  }
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_rpcclient_get_block_height() !== 10505) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_method_rpcclient_get_block_height");
  }
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_rpcsyncprogressinspector_inspect() !== 55656) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_method_rpcsyncprogressinspector_inspect");
  }
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_syncprogressinspector_inspect() !== 21297) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_method_syncprogressinspector_inspect");
  }
  ...
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_constructor_wallet_new_from_multipath() !== 35912) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_constructor_wallet_new_from_multipath");
  }
  ...
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_wallet_broadcast_with_esplora() !== 50185) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_method_wallet_broadcast_with_esplora");
  }
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_wallet_broadcast_with_kyoto() !== 18184) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_method_wallet_broadcast_with_kyoto");
  }
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_wallet_broadcast_with_rpc() !== 30693) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_method_wallet_broadcast_with_rpc");
  }
  ...
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_wallet_derivation_of_spk() !== 54659) {
  ...
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_wallet_drain() !== 7368) {
  ...
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_wallet_full_scan_with_electrum() !== 3559) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_method_wallet_full_scan_with_electrum");
  }
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_wallet_full_scan_with_esplora() !== 20702) {
  ...
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_wallet_is_mine() !== 43647) {
  ...
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_wallet_send() !== 30966) {
  ...
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_wallet_sync_with_electrum() !== 47051) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_method_wallet_sync_with_electrum");
  }
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_wallet_sync_with_esplora() !== 46997) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_method_wallet_sync_with_esplora");
  }
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_wallet_sync_with_kyoto() !== 12234) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_method_wallet_sync_with_kyoto");
  }
  if (nativeModule().ubrn_uniffi_bdk_ffi_checksum_method_wallet_sync_with_rpc() !== 38475) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_bdk_ffi_checksum_method_wallet_sync_with_rpc");
  }
