...
import { AbstractFfiConverterByteArray, FfiConverterArray, FfiConverterArrayBuffer, FfiConverterBool, FfiConverterFloat64, FfiConverterInt32, FfiConverterInt64, FfiConverterObject, FfiConverterObjectWithCallbacks, FfiConverterOptional, FfiConverterUInt32, FfiConverterUInt64, FfiConverterUInt8, UniffiAbstractObject, UniffiEnum, UniffiError, UniffiInternalError, UniffiResult, UniffiRustCaller, destructorGuardSymbol, pointerLiteralSymbol, uniffiCreateFfiConverterString, uniffiCreateRecord, uniffiRustCallAsync, uniffiTraitInterfaceCall, uniffiTypeNameSymbol } from "uniffi-bindgen-react-native";
...
export async function createWalletFromMultipath(descriptor, network, dbPath, asyncOpts_) /*throws*/{
  ...
  try {
    return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_func_create_wallet_from_multipath(FfiConverterString.lower(descriptor), FfiConverterTypeNetwork.lower(network), FfiConverterString.lower(dbPath));
    }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_u64, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_u64, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_u64, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_u64, /*liftFunc:*/FfiConverterTypeWallet.lift.bind(FfiConverterTypeWallet), /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError));
  } catch (__error) {
    if (uniffiIsDebug && __error instanceof Error) {
      __error.stack = __stack;
...
export class EsploraClient extends UniffiAbstractObject {
  ...
  constructor(url) /*throws*/{
    super();
    const pointer = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_constructor_esploraclient_new(FfiConverterString.lower(url), callStatus);
    }, /*liftString:*/FfiConverterString.lift);
    this[pointerLiteralSymbol] = pointer;
...
const uniffiTypeEsploraClientObjectFactory = (() => {
  return {
    ...
    isConcreteType(obj) {
      return obj[destructorGuardSymbol] && obj[uniffiTypeNameSymbol] === "EsploraClient";
    }
  };
})();
...
export class FullScanProgressInspectorImpl extends UniffiAbstractObject {
  ...
  inspect(keychain, index, visited) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_fullscanprogressinspector_inspect(uniffiTypeFullScanProgressInspectorImplObjectFactory.clonePointer(this), FfiConverterTypeKeychainKind.lower(keychain), FfiConverterUInt32.lower(index), FfiConverterUInt64.lower(visited), callStatus);
    }, /*liftString:*/FfiConverterString.lift);
  }
...
const uniffiTypeFullScanProgressInspectorImplObjectFactory = (() => {
  return {
    ...
    isConcreteType(obj) {
      return obj[destructorGuardSymbol] && obj[uniffiTypeNameSymbol] === "FullScanProgressInspectorImpl";
    }
  };
})();
...
export class KyotoClient extends UniffiAbstractObject {
  ...
  constructor(wallet, scanType, requiredPeers, peers, dataDir, handler) /*throws*/{
    super();
    const pointer = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_constructor_kyotoclient_new(FfiConverterTypeWallet.lower(wallet), FfiConverterTypeKyotoScanType.lower(scanType), FfiConverterUInt8.lower(requiredPeers), FfiConverterArrayString.lower(peers), FfiConverterString.lower(dataDir), FfiConverterTypeKyotoNodeEventHandler.lower(handler), callStatus);
    }, /*liftString:*/FfiConverterString.lift);
    this[pointerLiteralSymbol] = pointer;
...
const uniffiTypeKyotoClientObjectFactory = (() => {
  return {
    ...
    isConcreteType(obj) {
      return obj[destructorGuardSymbol] && obj[uniffiTypeNameSymbol] === "KyotoClient";
    }
  };
})();
...
export class KyotoNodeEventHandlerImpl extends UniffiAbstractObject {
  ...
  onInfo(message) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_kyotonodeeventhandler_on_info(uniffiTypeKyotoNodeEventHandlerImplObjectFactory.clonePointer(this), FfiConverterString.lower(message), callStatus);
    }, /*liftString:*/FfiConverterString.lift);
  }
  ...
  onWarning(message) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_kyotonodeeventhandler_on_warning(uniffiTypeKyotoNodeEventHandlerImplObjectFactory.clonePointer(this), FfiConverterString.lower(message), callStatus);
    }, /*liftString:*/FfiConverterString.lift);
  }
...
const uniffiTypeKyotoNodeEventHandlerImplObjectFactory = (() => {
  return {
    ...
    isConcreteType(obj) {
      return obj[destructorGuardSymbol] && obj[uniffiTypeNameSymbol] === "KyotoNodeEventHandlerImpl";
    }
  };
})();
...
export class RpcClient extends UniffiAbstractObject {
  ...
  constructor(url, username, password, cookieFile) /*throws*/{
    super();
    const pointer = uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_constructor_rpcclient_new(FfiConverterString.lower(url), FfiConverterOptionalString.lower(username), FfiConverterOptionalString.lower(password), FfiConverterOptionalString.lower(cookieFile), callStatus);
    }, /*liftString:*/FfiConverterString.lift);
    this[pointerLiteralSymbol] = pointer;
...
const uniffiTypeRpcClientObjectFactory = (() => {
  return {
    ...
    isConcreteType(obj) {
      return obj[destructorGuardSymbol] && obj[uniffiTypeNameSymbol] === "RpcClient";
    }
  };
})();
...
export class RpcSyncProgressInspectorImpl extends UniffiAbstractObject {
  ...
  inspect(currentHeight, tipHeight) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_rpcsyncprogressinspector_inspect(uniffiTypeRpcSyncProgressInspectorImplObjectFactory.clonePointer(this), FfiConverterUInt32.lower(currentHeight), FfiConverterUInt32.lower(tipHeight), callStatus);
    }, /*liftString:*/FfiConverterString.lift);
  }
...
const uniffiTypeRpcSyncProgressInspectorImplObjectFactory = (() => {
  return {
    ...
    isConcreteType(obj) {
      return obj[destructorGuardSymbol] && obj[uniffiTypeNameSymbol] === "RpcSyncProgressInspectorImpl";
    }
  };
})();
...
export class SyncProgressInspectorImpl extends UniffiAbstractObject {
  ...
  inspect(consumed, total) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_syncprogressinspector_inspect(uniffiTypeSyncProgressInspectorImplObjectFactory.clonePointer(this), FfiConverterUInt64.lower(consumed), FfiConverterUInt64.lower(total), callStatus);
    }, /*liftString:*/FfiConverterString.lift);
  }
...
const uniffiTypeSyncProgressInspectorImplObjectFactory = (() => {
  return {
    ...
    isConcreteType(obj) {
      return obj[destructorGuardSymbol] && obj[uniffiTypeNameSymbol] === "SyncProgressInspectorImpl";
    }
  };
})();
...
export class Wallet extends UniffiAbstractObject {
  ...
  static newFromMultipath(descriptor, network, dbPath) /*throws*/{
    return FfiConverterTypeWallet.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_constructor_wallet_new_from_multipath(FfiConverterString.lower(descriptor), FfiConverterTypeNetwork.lower(network), FfiConverterString.lower(dbPath), callStatus);
    }, /*liftString:*/FfiConverterString.lift));
  }
  ...
  async broadcastWithEsplora(client, psbt, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_broadcast_with_esplora(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeEsploraClient.lower(client), FfiConverterTypePsbt.lower(psbt));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_rust_buffer, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_rust_buffer, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_rust_buffer, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_rust_buffer, /*liftFunc:*/FfiConverterString.lift.bind(FfiConverterString), /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
  ...
  async broadcastWithKyoto(client, psbt, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_broadcast_with_kyoto(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeKyotoClient.lower(client), FfiConverterTypePsbt.lower(psbt));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_rust_buffer, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_rust_buffer, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_rust_buffer, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_rust_buffer, /*liftFunc:*/FfiConverterString.lift.bind(FfiConverterString), /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
  ...
  async broadcastWithRpc(client, psbt, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_broadcast_with_rpc(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeRpcClient.lower(client), FfiConverterTypePsbt.lower(psbt));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_rust_buffer, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_rust_buffer, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_rust_buffer, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_rust_buffer, /*liftFunc:*/FfiConverterString.lift.bind(FfiConverterString), /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
  ...
  async drain(address, feeRate, client, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_drain(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(address), FfiConverterFloat64.lower(feeRate), FfiConverterTypeEsploraClient.lower(client));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_rust_buffer, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_rust_buffer, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_rust_buffer, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_rust_buffer, /*liftFunc:*/FfiConverterString.lift.bind(FfiConverterString), /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
  ...
  async fullScanWithElectrum(client, stopGap, inspector, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_full_scan_with_electrum(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeElectrumClient.lower(client), FfiConverterUInt64.lower(stopGap), FfiConverterOptionalTypeFullScanProgressInspector.lower(inspector));
  ...
  async fullScanWithEsplora(client, stopGap, inspector, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_full_scan_with_esplora(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeEsploraClient.lower(client), FfiConverterUInt64.lower(stopGap), FfiConverterOptionalTypeFullScanProgressInspector.lower(inspector));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_void, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_void, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_void, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
  ...
  async send(address, amountSats, feeRate, client, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_send(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(address), FfiConverterUInt64.lower(amountSats), FfiConverterFloat64.lower(feeRate), FfiConverterTypeEsploraClient.lower(client));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_rust_buffer, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_rust_buffer, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_rust_buffer, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_rust_buffer, /*liftFunc:*/FfiConverterString.lift.bind(FfiConverterString), /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
  ...
  async syncWithElectrum(client, stopGap, inspector, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_sync_with_electrum(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeElectrumClient.lower(client), FfiConverterUInt64.lower(stopGap), FfiConverterOptionalTypeSyncProgressInspector.lower(inspector));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_void, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_void, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_void, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
  ...
  async syncWithEsplora(client, stopGap, inspector, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_sync_with_esplora(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeEsploraClient.lower(client), FfiConverterUInt64.lower(stopGap), FfiConverterOptionalTypeSyncProgressInspector.lower(inspector));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_void, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_void, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_void, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
  ...
  async syncWithKyoto(client, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_sync_with_kyoto(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeKyotoClient.lower(client));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_void, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_void, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_void, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
  ...
  async syncWithRpc(client, startHeight, fetchMempool, inspector, asyncOpts_) /*throws*/{
    ...
    try {
      return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_sync_with_rpc(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterTypeRpcClient.lower(client), FfiConverterUInt32.lower(startHeight), FfiConverterBool.lower(fetchMempool), FfiConverterOptionalTypeRpcSyncProgressInspector.lower(inspector));
      }, /*pollFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_poll_void, /*cancelFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_cancel_void, /*completeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_complete_void, /*freeFunc:*/nativeModule().ubrn_ffi_bdk_ffi_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
