...
export class Wallet extends UniffiAbstractObject {
   ...
   */
  broadcastWithEsplora(url, psbt) /*throws*/{
    return FfiConverterString.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_broadcast_with_esplora(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(url), FfiConverterTypePsbt.lower(psbt), callStatus);
    }, /*liftString:*/FfiConverterString.lift));
  }
   ...
   */
  drain(address, feeRate, esploraUrl) /*throws*/{
    return FfiConverterString.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_drain(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(address), FfiConverterFloat64.lower(feeRate), FfiConverterString.lower(esploraUrl), callStatus);
    }, /*liftString:*/FfiConverterString.lift));
  }
   ...
   */
  fullScanWithEsplora(url, stopGap) /*throws*/{
    uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_full_scan_with_esplora(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(url), FfiConverterUInt64.lower(stopGap), callStatus);
    }, /*liftString:*/FfiConverterString.lift);
  }
   ...
   */
  send(address, amountSats, feeRate, esploraUrl) /*throws*/{
    return FfiConverterString.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      return nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_send(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(address), FfiConverterUInt64.lower(amountSats), FfiConverterFloat64.lower(feeRate), FfiConverterString.lower(esploraUrl), callStatus);
    }, /*liftString:*/FfiConverterString.lift));
  }
   ...
   */
  syncWithEsplora(url, stopGap) /*throws*/{
    uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeBdkError.lift.bind(FfiConverterTypeBdkError), /*caller:*/callStatus => {
      nativeModule().ubrn_uniffi_bdk_ffi_fn_method_wallet_sync_with_esplora(uniffiTypeWalletObjectFactory.clonePointer(this), FfiConverterString.lower(url), FfiConverterUInt64.lower(stopGap), callStatus);
    }, /*liftString:*/FfiConverterString.lift);
  }
