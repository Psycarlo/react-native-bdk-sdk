...
interface NativeModuleInterface {
    ...
    ubrn_uniffi_bdk_ffi_fn_clone_kyotoclient(handle: bigint, uniffi_out_err: UniffiRustCallStatus): bigint;
    ubrn_uniffi_bdk_ffi_fn_free_kyotoclient(handle: bigint, uniffi_out_err: UniffiRustCallStatus): void;
    ...
    ubrn_uniffi_bdk_ffi_fn_method_kyotoclient_is_running(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): number;
    ubrn_uniffi_bdk_ffi_fn_method_kyotoclient_shutdown(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_clone_kyotonodeeventhandler(handle: bigint, uniffi_out_err: UniffiRustCallStatus): bigint;
    ubrn_uniffi_bdk_ffi_fn_free_kyotonodeeventhandler(handle: bigint, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_init_callback_vtable_kyotonodeeventhandler(vtable: UniffiVTableCallbackInterfaceKyotoNodeEventHandler): void;
    ubrn_uniffi_bdk_ffi_fn_method_kyotonodeeventhandler_on_info(ptr: bigint, message: Uint8Array, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_kyotonodeeventhandler_on_warning(ptr: bigint, message: Uint8Array, uniffi_out_err: UniffiRustCallStatus): void;
    ...
    ubrn_uniffi_bdk_ffi_fn_method_mnemonic_language(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_bdk_ffi_fn_method_mnemonic_to_seed_hex(ptr: bigint, passphrase: Uint8Array, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_bdk_ffi_fn_method_mnemonic_to_string(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_bdk_ffi_fn_method_mnemonic_word_count(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): number;
    ubrn_uniffi_bdk_ffi_fn_method_mnemonic_words(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_bdk_ffi_fn_clone_psbt(handle: bigint, uniffi_out_err: UniffiRustCallStatus): bigint;
    ubrn_uniffi_bdk_ffi_fn_free_psbt(handle: bigint, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_constructor_psbt_new(psbtBase64: Uint8Array, uniffi_out_err: UniffiRustCallStatus): bigint;
    ubrn_uniffi_bdk_ffi_fn_method_psbt_extract_tx_hex(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_bdk_ffi_fn_method_psbt_fee_amount(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_bdk_ffi_fn_method_psbt_fee_rate(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ...
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_add_data(ptr: bigint, data: Uint8Array, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_add_global_xpubs(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_add_recipient(ptr: bigint, address: Uint8Array, amountSats: bigint, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_add_unspendable(ptr: bigint, outpoint: Uint8Array, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_add_utxo(ptr: bigint, outpoint: Uint8Array, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_add_utxos(ptr: bigint, outpoints: Uint8Array, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_allow_dust(ptr: bigint, allow: number, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_change_policy(ptr: bigint, policy: Uint8Array, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_current_height(ptr: bigint, height: number, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_do_not_spend_change(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_drain_to(ptr: bigint, address: Uint8Array, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_drain_wallet(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_enable_rbf(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_enable_rbf_with_sequence(ptr: bigint, nsequence: number, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_exclude_below_confirmations(ptr: bigint, minConfirms: number, uniffi_out_err: UniffiRustCallStatus): void;
    ...
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_only_witness_utxo(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_ordering(ptr: bigint, ordering: Uint8Array, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_policy_path(ptr: bigint, pathMapJson: Uint8Array, keychain: Uint8Array, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_set_exact_sequence(ptr: bigint, nsequence: number, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_set_recipients(ptr: bigint, recipients: Uint8Array, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_sighash(ptr: bigint, sighashType: number, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_tx_version(ptr: bigint, version: number, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_txbuilder_unspendable(ptr: bigint, outpoints: Uint8Array, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_clone_fullscanprogressinspector(handle: bigint, uniffi_out_err: UniffiRustCallStatus): bigint;
    ...
    ubrn_uniffi_bdk_ffi_fn_method_syncprogressinspector_inspect(ptr: bigint, consumed: bigint, total: bigint, uniffi_out_err: UniffiRustCallStatus): void;
    ...
    ubrn_uniffi_bdk_ffi_fn_method_wallet_full_scan_with_electrum(ptr: bigint, client: bigint, stopGap: bigint, inspector: Uint8Array): bigint;
    ubrn_uniffi_bdk_ffi_fn_method_wallet_full_scan_with_esplora(ptr: bigint, client: bigint, stopGap: bigint, inspector: Uint8Array): bigint;
    ...
    ubrn_uniffi_bdk_ffi_fn_method_wallet_insert_txout(ptr: bigint, outpoint: Uint8Array, txout: Uint8Array, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_bdk_ffi_fn_method_wallet_is_mine(ptr: bigint, scriptHex: Uint8Array, uniffi_out_err: UniffiRustCallStatus): number;
    ubrn_uniffi_bdk_ffi_fn_method_wallet_keychains(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_bdk_ffi_fn_method_wallet_latest_checkpoint(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_bdk_ffi_fn_method_wallet_list_output(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_bdk_ffi_fn_method_wallet_list_unspent(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_bdk_ffi_fn_method_wallet_list_unused_addresses(ptr: bigint, keychain: Uint8Array, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_bdk_ffi_fn_method_wallet_mark_used(ptr: bigint, keychain: Uint8Array, index: number, uniffi_out_err: UniffiRustCallStatus): number;
    ubrn_uniffi_bdk_ffi_fn_method_wallet_network(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_bdk_ffi_fn_method_wallet_next_derivation_index(ptr: bigint, keychain: Uint8Array, uniffi_out_err: UniffiRustCallStatus): number;
    ubrn_uniffi_bdk_ffi_fn_method_wallet_next_unused_address(ptr: bigint, keychain: Uint8Array, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_bdk_ffi_fn_method_wallet_peek_address(ptr: bigint, keychain: Uint8Array, index: number, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_bdk_ffi_fn_method_wallet_persist(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): number;
    ubrn_uniffi_bdk_ffi_fn_method_wallet_policies(ptr: bigint, keychain: Uint8Array, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
