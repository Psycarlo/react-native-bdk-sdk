...
package com.reactnativebdksdk

import com.facebook.react.bridge.ReactApplicationContext
import com.facebook.react.module.annotations.ReactModule
import com.facebook.react.turbomodule.core.interfaces.CallInvokerHolder

@ReactModule(name = BdkSdkModule.NAME)
class BdkSdkModule(reactContext: ReactApplicationContext) :
  NativeBdkSdkSpec(reactContext) {
  ...
  companion object {
    const val NAME = "BdkSdk"

    init {
      System.loadLibrary("react-native-bdk-sdk")
    }
  }
}